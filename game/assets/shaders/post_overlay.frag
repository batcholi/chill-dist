...
#line 2 "/home/olivier/projects/chill/src/v4d/game/assets/shaders/post_overlay.glsl"


#line 7 "/home/olivier/projects/chill/src/v4d/game/assets/shaders/post_overlay.glsl"

layout(set = 1, input_attachment_index = 0, binding = SET1_BINDING_IN_IMG_OVERLAY) uniform subpassInput in_img_overlay;
layout(location = 0) out vec4 out_swapchain;

void main() {
	out_swapchain = subpassLoad(in_img_overlay);
}
