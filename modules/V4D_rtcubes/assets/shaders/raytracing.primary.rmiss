...
void main() {
	...
	ray.color = vec4(renderer.skyLightColor * vec3(0.7,0.7,1.0), 1.0);
	ray.color = vec4(renderer.skyLightColor * mix(vec3(0.7,0.7,1.0), abs(gl_WorldRayDirectionEXT), 0.5), 1.0);
	ray.index = uvec2(0,0);
